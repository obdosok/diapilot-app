...
class LedgerRecordsShownArmTest {
    ...
    private val forecaster = source("src/main/java/com/example/diapilot/data/Forecaster.kt")
    ...
    fun `refusal rows never mark real generations dead`() {
        val retention = source("src/main/java/com/example/diapilot/data/LedgerRetention.kt")
        assertTrue(
