...
class InsulinProfileContractTest {
    ...
    @Test fun `the timing profile carries no amplitude`() {
        val src = File("src/main/java/com/example/diapilot/data/InsulinProfileRuntime.kt")
            .let { if (it.exists()) it else File("app/src/main/java/com/example/diapilot/data/InsulinProfileRuntime.kt") }
            .readText()
    ...
    @Test fun `only one implementation feeds the person model`() {
        val src = File("src/main/java/com/example/diapilot/data/PhysioRuntime.kt")
            .let { if (it.exists()) it else File("app/src/main/java/com/example/diapilot/data/PhysioRuntime.kt") }
            .readText()
