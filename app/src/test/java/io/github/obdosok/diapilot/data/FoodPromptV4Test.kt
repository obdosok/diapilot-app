...
class FoodPromptV4Test {
    private val src: String =
        File("src/main/java/io/github/obdosok/diapilot/data/AskClaude.kt")
            .let { if (it.exists()) it else File("app/src/main/java/io/github/obdosok/diapilot/data/AskClaude.kt") }
            .readText()
